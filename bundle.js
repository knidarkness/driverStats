...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__gradients__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__gradients___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__gradients__);



const createRow = () => {
    const rectContainer = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* select */]('#container').append("svg")
        .attr("width", '100%')
        .attr("height", 30);
    __WEBPACK_IMPORTED_MODULE_1__gradients__["appendLargeGradient"](rectContainer);
    __WEBPACK_IMPORTED_MODULE_1__gradients__["appendMediumGradient"](rectContainer);
    __WEBPACK_IMPORTED_MODULE_1__gradients__["appendSmallGradient"](rectContainer);
...
__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* csv */]('data/busdata-temp.csv', ((err, data) => {
